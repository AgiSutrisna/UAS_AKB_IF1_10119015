...
public class NB_Database extends SQLiteOpenHelper {
    private static final int  DATABASE_VERSION = 2;
    private static final String DATABASE_NAME = "dbnotebook";
    ...
    public NB_Database(Context context){
    ...
    public long addNote(Notebook notebook){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues c = new ContentValues();
        c.put(KEY_TITLE, notebook.getTitle());
        c.put(KEY_CONTENT, notebook.getContent());
        c.put(KEY_CATEGORY, notebook.getCategory());
        c.put(KEY_DATE, notebook.getDate());
        c.put(KEY_TIME, notebook.getTime());
    ...
    public Notebook getNote(long id){
        ...
        return new Notebook(Long.parseLong(cursor.getString(0)),cursor.getString(1),cursor.getString(2),cursor.getString(3),
                cursor.getString(4), cursor.getString(5));

    }
    public List<Notebook> getNotes(){
        SQLiteDatabase db = this.getReadableDatabase();
        List<Notebook> allNotes = new ArrayList<>();
    ...
    public int editNote(Notebook note){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues c = new ContentValues();
